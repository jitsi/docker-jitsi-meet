...
{{ $VIDEOQUALITY_BITRATE_VP8_LOW := .Env.VIDEOQUALITY_BITRATE_VP8_LOW | default "200000" -}}
{{ $VIDEOQUALITY_BITRATE_VP8_STANDARD := .Env.VIDEOQUALITY_BITRATE_VP8_STANDARD | default "500000" -}}
{{ $VIDEOQUALITY_BITRATE_VP8_HIGH := .Env.VIDEOQUALITY_BITRATE_VP8_HIGH | default "1500000" -}}
{{ $VIDEOQUALITY_BITRATE_VP9_LOW := .Env.VIDEOQUALITY_BITRATE_VP9_LOW | default "100000" -}}
{{ $VIDEOQUALITY_BITRATE_VP9_STANDARD := .Env.VIDEOQUALITY_BITRATE_VP9_STANDARD | default "300000" -}}
{{ $VIDEOQUALITY_BITRATE_VP9_HIGH := .Env.VIDEOQUALITY_BITRATE_VP9_HIGH | default "1200000" -}}
...
config.videoQuality.maxBitratesVideo.H264 = { low: {{ $VIDEOQUALITY_BITRATE_H264_LOW }}, standard: {{ $VIDEOQUALITY_BITRATE_H264_STANDARD }}, high: {{ $VIDEOQUALITY_BITRATE_VP8_HIGH }} };
config.videoQuality.maxBitratesVideo.VP8 = { low: {{ $VIDEOQUALITY_BITRATE_VP8_LOW }}, standard: {{ $VIDEOQUALITY_BITRATE_VP8_STANDARD }}, high: {{ $VIDEOQUALITY_BITRATE_VP8_HIGH }} };
config.videoQuality.maxBitratesVideo.VP9 = { low: {{ $VIDEOQUALITY_BITRATE_VP9_LOW }}, standard: {{ $VIDEOQUALITY_BITRATE_VP9_STANDARD }}, high: {{ $VIDEOQUALITY_BITRATE_VP9_HIGH }} };
{{ end -}}