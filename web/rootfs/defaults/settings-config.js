...
{{ $ENABLE_VISITORS := .Env.ENABLE_VISITORS | default "false" | toBool -}}
...
{{ if .Env.ENABLE_VISITORS }}
config.conferenceRequestUrl=  'https://<!--# echo var="http_host" default="jitsi-meet.example.com" -->/' + subdir + 'conference-request/v1',
{{ end -}}
