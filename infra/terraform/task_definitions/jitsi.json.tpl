[
    {
        ...
        "mountPoints": [
            {
                "sourceVolume": "config-prosody",
                "containerPath": "/config",
                "readOnly": false
            },
            {
                "sourceVolume": "prosody-plugins",
                "containerPath": "/prosody-plugins",
                "readOnly": true
            }
        ],
        "logConfiguration": {
        ...
        "environment": [
            ...
            {
                "name": "XMPP_MUC_CONFIGURATION",
                "value": "muc_component='muc.meet.jitsi', api_prefix='${event_sync_api_url}'"
            },
            {
        ...
        "secrets": [
            {
                ...
                "valueFrom": "${jvb_auth_password_arn}"
            },
            {
                "name": "JICOFO_AUTH_PASSWORD",
                "valueFrom": "${jicofo_auth_password_arn}"
            },
            {
                "name": "JICOFO_COMPONENT_SECRET",
                "valueFrom": "${jicofo_component_secret_arn}"
            }
        ]
    },
    {
    ...
    },
    {
        ...
        "environment": [
            ...
            {
                "name": "JAVA_SYS_PROP_org.jitsi.videobridge.DISABLE_STUN",
                "value": "true"
            },
            {
            ...
            {
                "name": "JAVA_SYS_PROP_org.jitsi.videobridge.rest.jetty.port",
                "value": "8080"
            },
            {
                "name": "JAVA_SYS_PROP_org.ice4j.ice.harvest.DISABLE_STUN",
                "value": "true"
            },
            {
    ...
    },
    {
        ...
        "environment": [
            ...
            },
            {
                ...
                "value": "ws://127.0.0.1:5280/xmpp-websocket"
            },
            {
                "name": "JVB_WS_SERVER_ID",
                "value": "jvb"
